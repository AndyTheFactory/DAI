 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://endpoint/", wsdlLocation = "http://localhost:8080/hello-jaxws2.2/HelloService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://endpoint/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/hello-jaxws2.2/HelloService?WSDL");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://endpoint/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint/", "HelloPort"), Hello.class, features);
    }
